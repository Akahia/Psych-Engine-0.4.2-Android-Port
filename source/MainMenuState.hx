...
{
	public static var psychEngineVersion:String = '0.0.1 BETA'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Label Engine v" + psychEngineVersion, 12);
